...
@section('titulo','Home Page Director')
                    ...
                    <div class="message-box">
                        <div class="message-widget">
                            ...
                            <a href="#" class="my1">
                                ...
                                <div class="mail-contnet">
                                    <h5>Bubu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> 
                                    <span class="time">9:10 AM</span> 
                                </div>
                            </a>
                            <!-- Message -->
                            <a href="#" class="my1">
                                <div class="user-img"> <span class="round">A</span> 
...
@push('scripts')
    <script src="{{ asset('js/Grafico_Barras1.js') }}"></script>
    <script src="{{ asset('js/Grafico_Pizza.js') }}"></script>
    <script src="{{ asset('js/Grafico_barras_.js') }}"></script>
@endpush
