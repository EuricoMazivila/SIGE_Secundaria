...
<head>
    ...
    <link href="{{ asset('css/smartwizard_css/smart_wizard.css') }}" rel="stylesheet"/>
    <link href="{{ asset('css/style/steps.css') }}" rel="stylesheet">
    <link href="{{ asset('css/fontawesome_css/fontawesome.css') }}" rel="stylesheet" >
    
    <!-- Optional SmartWizard theme -->
    <link href="{{ asset('css/smartwizard_css/smart_wizard_theme_circles.css') }}" rel="stylesheet"/>
    <link href="{{ asset('css/smartwizard_css/smart_wizard_theme_arrows.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/smartwizard_css/smart_wizard_theme_dots.css') }}" rel="stylesheet" />

    <!--Css de Fileinput-->
    <link href="{{ asset('css/fileinput_css/fileinput.css') }} " rel="stylesheet">
...
<body>
    ...
    <footer class="mt-4">
        <div class="conatiner-fluid padding">
            <div class="row text-center">
                <div class="col-lg-12">
                    <p>&copy;Copyright 2019 | SIGA YOUNG | Sobre Nós</p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script src="{{ asset('js/smartwizard_js/jquery.smartWizard.js') }}"></script>
    <script src="{{ asset('js/popper.js') }}"></script>
    <script src="{{ asset('js/script/steps_pre_matricula.js')}}"></script>
    <script src="{{ asset('js/fontawesome_js/all.js') }}"></script>

    <!--Include FileInput Javascript-->
    <script src="{{ asset('js/fileinput_js/fileinput.js') }}"></script> 
    <!-- the fileinput plugin initialization -->
    <script src="{{ asset('js/script/fileinput.js') }}"></script>
