                ...
                <div class="menu-sm">
                    <li class="dropdown menu-sm">
                        ...
                        <ul class="dropdown-menu navbar-right menu-color" aria-labelledby="dropdownMenu1">
                            <li>
                                <a class="btn btn-default btn-lg btn-block  text-left" href="/secretaria/matricular/candidato"> <!--Verificar isto-->
                            ...
                            <li class="has-subnav">
                                <a class="btn btn-default btn-lg btn-block  text-left" href="/secretaria/registar/candidato"> <!--Ver bem-->
                                    <span class="i-color-white"> <i class="fa fa-plus-square fa-2x i-tamanho"></i>
                                        Registar candidato
                                    </span>
                                </a>
