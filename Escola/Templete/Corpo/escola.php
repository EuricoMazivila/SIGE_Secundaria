...
<div class="container">
    ...
    <div class="page-header" id="top">
        <h3 class="mt-2 offset-sm-1">Escola</h3>
        <hr>
                ...
                <div class="form-row">
                    <div class="col-sm-5">
                        ...
                        <select class="form-control" id="BairroEscola" name="BairroEscola">
                            <option>Albazine</option>
                            <option>Laulane</option>
                            <option>Mahota</option>
                            <option>Magoanine</option>
                            <option>Zimpeto</option>
                        </select>
                        <div class="help-block with-errors"></div>
                    </div>
            ...
            <fieldset>
                ...
                <div class="form-row">
                    <div class="col-sm-5">
                        ...
                        <select class="form-control" id="verConta" name="verConta">
                            <option>Sim</option>
                            <option>Nao</option>
