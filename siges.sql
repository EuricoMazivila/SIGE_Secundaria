...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 19, 2019 at 07:40 PM
...
INSERT INTO `endereco_pessoa` (`id_Pessoa`, `id_bairro`, `Avenida_Rua`, `Nr`, `Quar`) VALUES
(201900001, 1, 'Dos Lusiada', 201, 4);
...
(20190003, 'Malhazine', 'Secundaria', 'Publica', 10, 1);
...
INSERT INTO `localizacao_escola` (`id_escola`, `id_bairro`, `Avenida_Rua`, `Nr`, `Quar`) VALUES
(20190001, 2, 'De Mocambique', 2202, 12),
(20190003, 5, 'Gago Coutinho', 20119, 14),
(20190002, 10, 'de Mocambique', 1234, 14);
...
(11, 201900001, 584518, '2019-09-20', 'barato', 'tereza', 'Email', 'BaratoCandido@gmail.com'),
(12, 201900001, 677840, '2019-09-20', 'tereza', 'barato', 'Email', 'BaratoCandido@gmail.com'),
(13, 201900002, 657395, '2019-09-20', 'candido', 'paulo', 'Telefone', '825794562');
...
(201900001, 10, 'Ativo', 'N', 'N', 'N'),
(201900004, 3, 'Ativo', 'N', 'N', 'N');

--
-- Triggers `user_distrital`
--
DELIMITER $$
CREATE TRIGGER `ActualizaUsuarioD` AFTER INSERT ON `user_distrital` FOR EACH ROW UPDATE `usuario` SET Acesso_Distrital = 'S',Acesso_Convidado='N' WHERE `usuario`.`id_User` = new.id_User
$$
DELIMITER ;
...
(201900002, 20190001, 'Aluno', 'Ativo'),
(201900003, 20190002, 'Directoria', 'Ativo');

--
-- Triggers `user_escola`
--
DELIMITER $$
CREATE TRIGGER `ActualizaUsuarioR` AFTER INSERT ON `user_escola` FOR EACH ROW UPDATE `usuario` SET `Acesso_Escola` = 'S' WHERE `usuario`.`id_User` = new.id_User
$$
DELIMITER ;
...
(201900001, 'Candido3', 'barato', 'Barato.Candido.201900001@sige.ac.mz', 'Ativo', '2019-09-17', 'S', 'N', 'N'),
(201900002, 'Paulo201900002', 'paulo', 'Mondlane.Paulo.201900002@sige.ac.mz', 'Ativo', '2019-09-17', 'N', 'S', 'N'),
(201900003, 'Eurico201900003', 'Mazivila', 'Mazivila.Eurico.201900003@sige.ac.mz', 'Ativo', '2019-09-17', 'N', 'S', 'N'),
(201900004, 'Absalao201900004', 'Nhatumbo', 'Nhatumbo.Absalao.201900004@sige.ac.mz', 'Ativo', '2019-09-17', 'S', 'N', 'N');
...
--
ALTER TABLE `escola`
  MODIFY `id_Escola` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20190004;
...
--
ALTER TABLE `endereco_pessoa`
  ADD CONSTRAINT `endereco_pessoa_ibfk_1` FOREIGN KEY (`id_Pessoa`) REFERENCES `pessoa` (`id_Pessoa`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `endereco_pessoa_ibfk_2` FOREIGN KEY (`id_bairro`) REFERENCES `bairro` (`id_Bairro`) ON DELETE CASCADE ON UPDATE CASCADE;
