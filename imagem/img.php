        ...
        <form method="POST" action="processa.php" enctype="multipart/form-data" id="uploadImageForma">
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-6 mt-6">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-12">
                        <input type="text" class="form-control" name="nome" id="inputNivel">        
                    </div>
                </div> 
            </div>
            ...
            <button type="submit" class="btn btn-success" name="submeter"> <i class="fas fa-save"></i> &nbsp; Submeter</button>
