...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Set-2019 às 14:16
...
--
-- Estrutura da tabela `matricula_marcada`
--
...
--
-- Extraindo dados da tabela `matricula_marcada`
--
...
--
-- Estrutura da tabela `pessoa_nascimento`
--
...
--
-- Extraindo dados da tabela `pessoa_nascimento`
--
...
--
-- Extraindo dados da tabela `user_distrital`
--
...
(201900002, 'Paulo201900002', 'candido', 'Mondlane.Paulo.201900002@sige.ac.mz', 'Ativo', '2019-09-17', 'N', 'S', 'N'),
...
--
-- Limitadores para a tabela `matricula_marcada`
--
ALTER TABLE `matricula_marcada`
...
--
-- Limitadores para a tabela `pessoa_documento`
--
ALTER TABLE `pessoa_documento`
...
--
-- Limitadores para a tabela `pessoa_nascimento`
--
ALTER TABLE `pessoa_nascimento`
